    ...
    <div role="tablist">
        <b-card no-body class="mb-1">
            <b-card-header header-tag="header" class="p-1" role="tab">
                <b-button block href="#" v-b-toggle.accordion-1 test-id="vehicles_menu" variant="info">Транспортные средства</b-button>
            </b-card-header>
            <b-collapse id="accordion-1" visible accordion="my-accordion" role="tabpanel">
                <b-card-body>
                    <p><router-link to="/transports">Список транспортных средств</router-link></p>
                    <p><router-link to="/transports/add">Добавить транспорт</router-link></p>
        ...
        <b-card no-body class="mb-1">
            <b-card-header header-tag="header" class="p-1" role="tab">
                <b-button block href="#" v-b-toggle.accordion-2 test-id="orders_menu" variant="info">Заказы</b-button>
            </b-card-header>
        ...
        <b-card no-body class="mb-1">
            <b-card-header header-tag="header" class="p-1" role="tab">
                <b-button block href="#" v-b-toggle.accordion-3 test-id="cargoes_menu" variant="info">Грузы</b-button>
            </b-card-header>
        ...
        <b-card no-body class="mb-1">
            <b-card-header header-tag="header" class="p-1" role="tab">
                <b-button block href="#" v-b-toggle.accordion-4 test-id="employees_menu" variant="info">Сотрудники</b-button>
            </b-card-header>
